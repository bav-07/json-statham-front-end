...
const MovieCard = ({movie}) => {
    ...
    return (  
        ...
        <div className="movieCard h-fit w-[225px] relative mx-[20px] mb-[25vh]">
            ...
            <img className="cardImage  w-full object-cover hover:shadow-black shadow-2xl transition-all" src={movieData.Poster} alt={`${movie.title} movie poster`}/> 
                <div className="absolute transition-all bottom-0 p-5 opacity-0 group-hover:opacity-100 bg-gradient-to-b from-black/0 to-black via-gray-900 h-[50%] grid content-end w-full">
                    <h4 className="text-white font-bold font-['Roboto'] w-[fit] whitespace-normal"> {movie.title}</h4> 
