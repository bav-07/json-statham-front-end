...
<div className='main h-full w-full'>
        ...
        <div className='content absolute w-full h-full top-0 flex flex-col items-center justify-center text-white'>
            <h1 className="text-9xl font-['Inter'] font-extrabold z-50">Search. <span className='text-transparent bg-clip-text bg-gradient-to-br  from-cyan-300 to-blue-600'>Review.</span></h1>
